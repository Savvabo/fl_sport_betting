...
def get_forecast_description(forecast_link):
    ...
    forecast_description = soup.find('div', class_='rate-name-text').text
...
def parse_forecasts(page):
    ...
    for forecast in forecasts:
        ...
        try:
            forecast_data['forecast_date'] = get_date_from_str(forecast.find('div', class_='forecast-preview__date').text.strip())
        ...
        forecast_data['forecast_link'] = 'https://odds.ru{}'.format(forecast.find('div', class_='forecast-preview__title').a['href'])
        try:
